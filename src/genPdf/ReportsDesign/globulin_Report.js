import { GLOBULIN_RANGE } from "../../utils/rangeForTests";
import { getArrowValue, getValOrDash } from "../../utils/utilitiesFunc";

export function Globulin_Design(doc, y, globulinVal) {
    y += 12;
    let arrowVal = false;
    [...GLOBULIN_RANGE].forEach((field) => {
        ...
        arrowVal = getArrowValue(globulinVal, field.range, doc, 80, y - 3.5);
